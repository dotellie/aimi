...
call s:hi("WarningMsg", s:aimi_0, s:aimi_9, "", "")
...
call s:hi("Boolean", s:aimi_9, "", "", "")
call s:hi("Character", s:aimi_C, "", "", "")
call s:hi("Comment", s:aimi_3, "", s:italicize_comments, "")
call s:hi("Conditional", "", "", "", "")
call s:hi("Constant", s:aimi_9, "", "", "")
call s:hi("Define", s:aimi_8, "", "", "")
call s:hi("Delimiter", "", "", "", "")
call s:hi("Exception", s:aimi_8, "", "", "")
call s:hi("Float", s:aimi_9, "", "", "")
call s:hi("Function", s:aimi_D, "", "", "")
call s:hi("Identifier", s:aimi_4, "", "NONE", "")
call s:hi("Include", s:aimi_D, "", "", "")
call s:hi("Keyword", s:aimi_7, "", "BOLD", "")
call s:hi("Label", s:aimi_4, "", "", "")
call s:hi("Number", s:aimi_9, "", "", "")
call s:hi("Operator", s:aimi_5, "", "NONE", "")
call s:hi("PreProc", s:aimi_F, "", "NONE", "")
call s:hi("Repeat", s:aimi_E, "", "", "")
call s:hi("Special", s:aimi_5, "", "", "")
call s:hi("SpecialChar", s:aimi_5, "", "", "")
call s:hi("SpecialComment", s:aimi_C, "", s:italicize_comments, "")
call s:hi("Statement", s:aimi_4, "", "NONE", "")
call s:hi("StorageClass", s:aimi_E, "", "", "")
call s:hi("String", s:aimi_B, "", "", "")
call s:hi("Structure", s:aimi_A, "", "", "")
call s:hi("Tag", s:aimi_9, "", "", "")
call s:hi("Todo", s:aimi_C, "NONE", "", "")
call s:hi("Type", s:aimi_D, "", "NONE", "")
call s:hi("Typedef", s:aimi_D, "", "", "")

call s:hi("DiffAdd", s:aimi_B, "", "", "")
call s:hi("DiffChange", s:aimi_E, "", "", "")
call s:hi("DiffDelete", s:aimi_8, "", "", "")
call s:hi("DiffText", s:aimi_D, "", "", "")

" ### Plugins ###

" Ale
call s:hi("ALEErrorSign", s:aimi_8, "", "", "")
call s:hi("ALEWarningSign", s:aimi_E, "", "", "")

" GitGutter
call s:hi("GitGutterAdd", s:aimi_B, "", "", "")
call s:hi("GitGutterChange", s:aimi_E, "", "", "")
